...
{
    public class ReconcileFileController : ApiController
    {
        ...
        public List<ReconcileInputs> Post()
        {
            var httpRequest = HttpContext.Current.Request;
            List<ReconcileInputs> returnResult = new List<ReconcileInputs>();
            ...
            foreach (string file in httpRequest.Files)
            {
                ...
                returnResult = _excelFileService.ParseExcelReconcile(inputSteam);
